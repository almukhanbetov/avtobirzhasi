...
export const translations = {
  ru: {
    ...
    "contact.adminLabel": "Связаться с администратором",
    ...
    "admin.listings.edit": "Редактировать",
    ...
    "sell.hero.title": "Продайте автомобиль через Автобиржу",
    ...
    "sell.hero.cta": "Подать объявление",

    "sell.steps.eyebrow": "Как проходит продажа",
    "sell.steps.title": "Пять шагов от объявления до сделки",
    "sell.steps.step1.title": "Разместите автомобиль",
    "sell.steps.step1.description":
      "Добавьте фотографии, выберите марку, модель, год выпуска, регион и укажите начальную цену.",
    "sell.steps.step2.title": "Цена автоматически снижается",
    "sell.steps.step2.description":
      "Цена продавца уменьшается на 1% в сутки согласно действующим правилам Автобиржи.",
  ...
  kz: {
    ...
    "contact.adminLabel": "Администратормен байланысу",
    ...
    "sell.hero.title": "Автокөлікті Автобиржа арқылы сатыңыз",
    "sell.hero.description":
      "Автокөлікті және қалаған бағаны көрсетіңіз. Баға ұсыныстарыңыз жақындасқанда, Автобиржа сатып алушыны табуға автоматты түрде көмектеседі.",
    "sell.hero.cta": "Хабарландыру беру",

    "sell.steps.eyebrow": "Сату қалай өтеді",
    "sell.steps.title": "Хабарландырудан мәмілеге дейінгі бес қадам",
    "sell.steps.step1.title": "Автокөлікті орналастырыңыз",
    "sell.steps.step1.description":
      "Фотосуреттер қосыңыз, марка, модель, шығарылған жылын, аймақты таңдап, бастапқы бағаны көрсетіңіз.",
    "sell.steps.step2.title": "Баға автоматты түрде төмендейді",
    "sell.steps.step2.description":
      "Сатушының бағасы Автобиржаның қолданыстағы ережелеріне сәйкес тәулігіне 1%-ға төмендейді.",
